...
const HeroSection = ({ onExplore }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full overflow-hidden leading-none -mt-1 relative z-10" style={{ transform: 'rotate(180deg)' }}>
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-[60px] md:h-[100px] block" style={{ fill: '#faf8f5' }}>
